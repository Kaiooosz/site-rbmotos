        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          <a href="#inicio" className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="hidden sm:block">
              <p className="font-display font-900 text-xl italic leading-none text-white tracking-wide">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {links.map((l) => (
              <a
                key={l.href}
                href={l.href}
                className="text-sm font-medium text-[#aaa] hover:text-white transition-colors duration-200 uppercase tracking-wider"
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-2 bg-[#25D366] hover:bg-[#1db954] text-white text-sm font-semibold px-4 py-2 rounded-full transition-colors duration-200"
            >
          ...
          <nav className="flex flex-col px-4 py-4 gap-1">
            {links.map((l) => (
              <a
                ...
                className="text-base font-medium text-[#aaa] hover:text-white py-3 border-b border-[#1f1f1f] uppercase tracking-wider"
              >
                {l.label}
              </a>
            ))}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 flex items-center justify-center gap-2 bg-[#25D366] text-white text-sm font-semibold px-4 py-3 rounded-full"
            >
              Falar no WhatsApp
            </a>
          </nav>
