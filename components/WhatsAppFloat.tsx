export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1db954] active:bg-[#18a349] text-white font-black text-sm pl-4 pr-5 rounded-full shadow-2xl shadow-[#25D366]/40 transition-all hover:scale-105 active:scale-95"
      style={{ height: "52px" }}
    >
