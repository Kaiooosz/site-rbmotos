export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#1db954] text-white font-semibold text-sm px-5 py-3.5 rounded-full shadow-2xl shadow-[#25D366]/30 transition-all duration-200 hover:scale-105 group"
      aria-label="WhatsApp"
    >
